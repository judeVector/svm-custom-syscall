...
impl FeatureSet {
    ...
    pub fn runtime_features(&self) -> SVMFeatureSet {
        SVMFeatureSet {
            ...
            get_unix_timestamp_syscall: self.is_active(&get_unix_timestamp_syscall::id()),
        }
    }
}
...
pub mod get_unix_timestamp_syscall {
    solana_pubkey::declare_id!("GmSguh4NQbmuxASNUwgNzmrxHANPEHMbKbRfESmjWXNW");
}
